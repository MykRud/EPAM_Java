...
public class UserUpdateCommandTest extends BaseTest{
    ...
    public void testExecuteWithCorrectUser() throws IOException, ServletException {
        ...
        when(request.getParameter("last_name")).thenReturn("Waine");
        ...
        when(request.getParameter("age")).thenReturn("36");
        when(request.getParameter("gender")).thenReturn("Male");
        when(request.getParameter("contact")).thenReturn("+7777777");

        when(request.getRequestDispatcher(anyString())).thenReturn(requestDispatcher);
        when(request.getRequestURI()).thenReturn("/Final_Task/userUpdate");
