            ...
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control pt-4 p-2" id="name" type="text" name="username" placeholder="<fmt:message key="login.placeholder.username"/>" data-sb-validations="required" />
                                <label for="name">
                            ...
                            <!-- Password input-->
                            <div class="form-floating mb-3">
                                <input class="form-control pt-4 p-2" id="name" name="password" type="password" placeholder="<fmt:message key="login.placeholder.password"/>" data-sb-validations="required" />
                                <label for="name">
