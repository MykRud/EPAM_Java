            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        <form id="contactForm" action="${pageContext.request.contextPath}/pages/admin/userUpdate?id=${requestScope.user.id}" method="post">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control"
                                        ...
                                        type="text" 
                                        placeholder="<fmt:message key="users.update.first_name.placeholder"/>" data-sb-validations="required" />
                                <label for="name">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" 
                                        ...
                                        type="text" 
                                        placeholder="<fmt:message key="users.update.last_name.placeholder"/>" data-sb-validations="required" />
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" 
                                        ...
                                        placeholder="<fmt:message key="users.update.gender.placeholder"/>"
                                        data-sb-validations="required" />
                                <label for="age"><fmt:message key="users.update.gender.label"/></label>
                                <div class="invalid-feedback" data-sb-feedback="name:required">
