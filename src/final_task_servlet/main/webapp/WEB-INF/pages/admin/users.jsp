        ...
        <table class="table table-striped custom-table">
          ...
          <tbody>
            ...
            <tr scope="row">
                ...
                <td>${user.contact}</td>   
                <td>
                    <a href="${pageContext.request.contextPath}/pages/admin/userUpdate?id=${user.id}" class="btn btn-primary bg-dark text-white">
                        Edit user
                    </a>
                </td> 
                <td>
                    <a href="${pageContext.request.contextPath}/pages/admin/userDelete?id=${user.id}" class="btn btn-primary bg-dark text-white">
                        Delete user
                    </a>
                </td>
            </tr>
