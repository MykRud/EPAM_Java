...
public class TypeAddCommandTest extends BaseTest{
    ...
    public void testExecute() throws IOException, ServletException {
        ...
        when(request.getParameter("name")).thenReturn("Physics");

        when(request.getRequestDispatcher(anyString())).thenReturn(requestDispatcher);
        when(request.getRequestURI()).thenReturn("/Final_Task/pages/admin/typesAdd");
