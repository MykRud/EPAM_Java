package task_advanced.task_6.test.observer.git;

import org.junit.Test;
import task_advanced.task_6.patterns.observer.git.GitRepoObservers;
import task_advanced.task_6.patterns.observer.git.Repository;
import task_advanced.task_6.patterns.observer.git.WebHook;
...
public class GitRepoObserversTest {
    ...
    public void readmeCase() {
        ...
        assertEquals(
                "[Event[MERGE, master, [Commit[Johnny Mnemonic, [Added README.md, Added project description]]," +
