                    ...
                    <div class="col-lg-8 col-xl-7">
                        <form:form modelAttribute="user" id="contactForm" action="registration" method="post" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="form-floating mb-3">
                                <fmt:message key="registration.first_name.placeholder" var="firstNamePl" />
                            ...
                            <!-- Last Name input-->
                            <div class="form-floating mb-3">
                                <fmt:message key="registration.last_name.placeholder" var="lastNamePl" />
                            ...
                            <!-- Password input-->
                            <div class="form-floating mb-3">
                                <fmt:message key="registration.password.placeholder" var="passwordPl" />
                                ...
                                <form:label path="password" for="name"><fmt:message key="registration.password.label"/></form:label>
                            ...
                            <!-- Age input-->
                            <div class="form-floating mb-3">
                                <fmt:message key="registration.age.placeholder" var="agePl" />
                                ...
                                <form:label path="age" for="age"><fmt:message key="registration.age.label"/></form:label>
                            ...
                            <!-- Gender input-->
                            <div class="form-floating mb-3">
                                <fmt:message key="registration.gender.placeholder" var="genderPl" />
                                ...
                                <form:label path="gender" for="gender"><fmt:message key="registration.gender.label"/></form:label>
                            ...
                            <!-- Contact input-->
                            <div class="form-floating mb-3">
                                <fmt:message key="registration.contact.placeholder" var="contactPl" />
                                ...
                                <form:label path="contact" for="phone"><fmt:message key="registration.contact.label"/> (+381234567890)</form:label>
