                    ...
                    <div class="col-lg-8 col-xl-7">
                        <form:form modelAttribute="activity" id="contactForm" method="post" action="activitiesAdd" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <form:label path="name" for="name"><fmt:message key="activities.add.activity_name.label"/></form:label>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                class="form-control" 
                                data-sb-validations="required" />
                                <form:label path="description" for="description"><fmt:message key="activities.add.description.label"/></form:label>
                                <div class="invalid-feedback" data-sb-feedback="name:required">
                        ...
                        <form:select path="type" class="selectpicker form-control border-0 mb-1 mt-3 px-4 py-4 rounded shadow" name="type" id="type">
                            <c:forEach items="${types}" var="type">
                                        <form:option value="${type.getName()}">
                                                ${type.toString()}
                                        </form:option>
                                    </c:forEach>
                        </form:select>
