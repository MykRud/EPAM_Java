...
class SetAdminTest {
    ...
    @InjectMocks
    private SetAdmin setAdminController;

    @BeforeEach
    void setUp() {
        MockitoAnnotations.initMocks(this);
        mvc = MockMvcBuilders.standaloneSetup(setAdminController).setRemoveSemicolonContent(false).build();
    }
    ...
    void setAdmin() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/admin/setAdmin?user_id=1"))
